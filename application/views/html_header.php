...
<head>
    ...
    <meta name="title" content="Caeli Comunicação" />
    <meta name="og:title" content="Caeli Comunicação" />
    <meta name="og:description" content="SOMOS UMA AGÊNCIA QUE UNE CRIAÇÃO E ESTRATÉGIA PARA OTIMIZAÇÃO DE RESULTADOS." />
    ...
    <meta property="og:title" content="Caeli Comunicação" />
    <meta property="og:image" content="<?= base_url(); ?>assets/images/compartilhamento.png" />
    <meta property="SOMOS UMA AGÊNCIA QUE UNE CRIAÇÃO E ESTRATÉGIA PARA OTIMIZAÇÃO DE RESULTADOS." />
    <meta property="og:url" content="https://www.caelicomunicacao.com.br" />
    <!-- property (faz funcionar no linkedin) -->
    <?php
    $meta = array(
